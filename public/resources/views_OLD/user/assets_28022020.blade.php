       ...
       <div class="card-body">
             ...
             @endphp  
                @if(!empty($asset_data))     
                    ...
                    @endforeach
                        <h1 class="text-center line-height-auto height-auto calculated_total_asset">&#163; {{ $AssetsCounter }}</h1>
                                        ...
                                        @if(!empty($asset_data))     
                                              @foreach($asset_data as $data)  
                                                    <ul class="table-body align-items-center flex-wrap">
                                                        ...
                                                        <li class="asset_estimated_value"> {{ $data->estimatedValue  }} </li>
                                                        <li> {{ $data->type }}</li>
                                                        {{-- <li></li> --}}
                                                        <li>
                                                                    ...
                                                                    <div class="col-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input
                                                                                ...
                                                                                name="assets_value" class="
                                                                                form-control assets_value" value="{{ $data->estimatedValue}}" placeholder="Enter Assets Value
                                                                                ">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select
                                                                                ...
                                                                                name="assets_type"
                                                                                class="assets_type form-control"
                                                                                value = "{{ $data->type }}"
                                                                                style="width: 100%">
                                                                                @if(isset($data->type))
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-9"></div>
                                                                            <div class="col-md-3 mt-3">
                                                                                <input type="submit" name="submit" id="update_asset" class="btn btn-outline-info btn-large">
                                                                            </div>
                                                                        </div>
                                                                 </form>
                                                            </div>
