              ...
              @php 
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 d-flex justify-content-start">
                    <div class="row w-100 score-header">
                        ...
                        @endif
                        @if(isset($userListSignupQuestions))
                        <div class="d-inline-block {{$class}} p-0">
                            <h4 class="d-inline-block font-15">
                                @if(isset($userListSignupQuestions[0]->where_did_you_hear_about_us) && !empty($userListSignupQuestions[0]->where_did_you_hear_about_us))
                                <span style="font-size:15px;">{{ $userListSignupQuestions[0]->where_did_you_hear_about_us }}</span>
                                @endif
                            </h4>
                        </div>
                        @endif
