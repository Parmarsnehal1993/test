                                                ...
                                                @foreach($allAgentDataForCalendarValue[$currentWeekDatesValue] as $agentKey => $agentValue)
                                                     @if(isset($agentValue['agent_id']) && !empty($agentValue['agent_id']))
                                                        @php
                                                            ...
                                                            $str .= '<div class="dropdown-item select_agent_for_iva_calendar" data-agent_id="'.$agentValue["agent_id"].'" data-time_slot="'.$agentValue["slot"].'" data-slot_date="'.$agentValue["date"].'" data-slot_time="'.$loopHours[0].'">'.$agentValue["agent_name"].'</div>';
                                                        @endphp
                                                    @endif
                                                @endforeach
                                                @if($agentCount == 0)
