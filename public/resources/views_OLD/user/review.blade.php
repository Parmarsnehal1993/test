                ...
                <div class="modal-body">
                    ...
                    <div class="row mt-3 ml-0 mr-0">
                        ...
                        <!--<div class="form-group">
                            <label for="solution_display_by_option">Select Any Solution Option</label>
                            <select class="form-control" id="solution_display_by_option" name="solution_display_by_option">
