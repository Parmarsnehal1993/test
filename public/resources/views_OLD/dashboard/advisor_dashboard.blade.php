    ...
    <div class="container">
                ...
                <div class="chart-tools">
                    ...
                    <ul class="text-uppercase clearfix">
                        ...
                        <li class="border-yellow">
                            ...
                            <h4>{{ $advisorDashboardData['totalSentToDrafterCount'] }}</h4>

                            <p>NUMBER OF CASES SENT TO DRAFTER
        ...
        <div class="row table table-striped text-uppercase m-0" id="days">
            ...
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 dashboard-sidebar">
                ...
                <div class="row" style="padding-bottom:10px;border-bottom:1px solid #fff;">
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                        <h1>{{ $advisorDashboardData['awaitingDocsCasesCount'] }}</h1>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                        ...
                        <h1>
                            ...
                            {{ $advisorDashboardData['awaitingDocsCasesCountPercantage'] }}%
                ...
                <div class="row" style="padding-top: 15px;">
                    ...
                    <table class="table table-advisor" style="background: none;">
                        ...
                        @foreach ($advisorDashboardData['otherAdvisorsSentToDrafterData'] as $otherAdvisorsSentToDrafterDataKey => $otherAdvisorsSentToDrafterDataValue)

                            <tr>

                                <td>

                                    {{ getDrafterName($otherAdvisorsSentToDrafterDataKey) }}

                                </td>

                                <td>

                                    {{ $otherAdvisorsSentToDrafterDataValue }}
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            function ajaxCallForSearchedData(searched_date)
            {
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{ route('agent.get_searched_advisor_dashboard_data') }}',
                    data: {
        ...
        var DATE = [ @php print_r($advisorDashboardData['totalDates']) @endphp ];
        ...
        var dailyConfig = {
            ...
            data: {
                ...
                labels: [@php print_r($advisorDashboardData['currentDate']) @endphp],

                datasets: [

                    {
                        fill:false,
                        label: 'Total Daily Sent To Drafter Cases',

                        borderColor: '#ffc71a',

                        data: [@php print_r($advisorDashboardData['dailySentToDrafterString']) @endphp]
        ...
        var weeklyConfig = {
            ...
            data: {
                ...
                labels: [@php print_r($advisorDashboardData['currentWeekDates']) @endphp],

                datasets: [

                    {
                        fill:false,
                        label: 'Total Weekly Sent To Drafter Cases',

                        borderColor: '#ffc71a',

                        data: [@php print_r($advisorDashboardData['currentWeekTotalSentToDrafterString']) @endphp]
        ...
        var monthlyConfig = {
            ...
            data: {
                ...
                labels: [@php print_r($advisorDashboardData['currentMonthDates']) @endphp],

                datasets: [

                    {
                        fill:false,
                        label: 'Total Monthly Sent To Drafter Cases',

                        borderColor: '#ffc71a',

                        data: [@php print_r($advisorDashboardData['currentMonthTotalSentToDrafterString']) @endphp]
        ...
        var allTimeConfig = {
            type: 'line',
            data: {
                labels: [@php print_r($advisorDashboardData['totalDates']) @endphp],
                datasets: [
                    {
                        fill:false,
                        label: 'All Time Sent To Drafter Cases ',
                        borderColor: '#ffc71a',
                        data: [@php print_r($advisorDashboardData['finalSentToDrafterString']) @endphp]
                    }
                ]
            },
            options: {
