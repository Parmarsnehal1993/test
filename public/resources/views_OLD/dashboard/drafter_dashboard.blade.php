                ...
                <div class="chart-tools">
                    ...
                    <ul class="text-uppercase clearfix">
                        ...
                        <li class="border-yellow">
                            ...
                            <h4>{{ $drafterDashboardData['totalCompletedCasesCount'] }}</h4>number of complete cases
        ...
        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 dashboard-sidebar">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                    ...
                    <h1>{{ $drafterDashboardData['sentToIpCasesCount'] }}</h1>
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                    ...
                    <h1>{{ $drafterDashboardData['appointmentCount'] }}</h1>
            ...
            <div class="row" style="padding-top:10px;border-bottom:1px solid #fff;">
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                    ...
                    <h1>
                        ...
                        {{ $drafterDashboardData['sentToIpCasesCountPercentage'] }}%
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                    ...
                    <h1>
                        ...
                        {{ $drafterDashboardData['appointmentCountPercentage'] }}%
            ...
            <div class="row pt-10">
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                    ...
                    <h1 class="has-border">£ {{ $drafterDashboardData['totalDebtAmount'] }}</h1>
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                    ...
                    <h1 class="has-border">£ {{ $drafterDashboardData['averageDebtAmount'] }}</h1>
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            function ajaxCallForSearchedData(searched_date)
            {
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{ route('agent.get_searched_drafter_dashboard_data') }}',
                    data: {
        ...
        var dailyConfig = {
            ...
            data: {
                ...
                labels: [@php print_r($drafterDashboardData['currentDate']) @endphp],

                datasets: [

                    {
                        fill:false,
                        label: 'Total Daily Completed Cases',

                        borderColor: '#ffc71a',

                        data: [@php print_r($drafterDashboardData['dailyCompletedCasesString']) @endphp]
        ...
        var weeklyConfig = {
            ...
            data: {
                ...
                labels: [@php print_r($drafterDashboardData['currentWeekDates']) @endphp],

                datasets: [

                    {
                        fill:false,
                        label: 'Total Weekly Completed Cases',

                        borderColor: '#ffc71a',

                        data: [@php print_r($drafterDashboardData['currentWeekTotalCompletedCasesString']) @endphp]
        ...
        var monthlyConfig = {
            ...
            data: {
                ...
                labels: [@php print_r($drafterDashboardData['currentMonthDates']) @endphp],

                datasets: [

                    {
                        fill:false,
                        label: 'Total Monthly Completed Cases',

                        borderColor: '#ffc71a',

                        data: [@php print_r($drafterDashboardData['currentMonthTotalCompletedCasesString']) @endphp]
