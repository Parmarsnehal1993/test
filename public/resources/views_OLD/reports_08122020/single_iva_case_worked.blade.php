                ...
                <div class="row mt-5">
                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 pr-0 mb-3">
                        <div class="buttons float-right float-md-left float-lg-left float-xl-right small-buttons">
                            <a href="{{ route('downloadReport.excel', ['single_iva_case_worked' => 'single_iva_case_worked','agent_id' => $data['getSingleAgentData']['agent_id']]) }}" class="btn btn-outline-info btn-bordered-primary">
