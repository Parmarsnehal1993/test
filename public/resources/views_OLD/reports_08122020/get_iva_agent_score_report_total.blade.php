                ...
                <div class="row mt-5">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-6">
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <form action="{{ route('report.iva_quality_average_score')}}" method="get">
                                        @csrf
                                        <div class="row">
                                            <div class="col-6">
                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 pr-0 mb-3">
                        <div class="buttons float-right float-md-left float-lg-left float-xl-right small-buttons">
                            <a href="{{ route('downloadReport.excel', 'get_iva_agent_score_report_total') }}" class="btn btn-outline-info btn-bordered-primary">
