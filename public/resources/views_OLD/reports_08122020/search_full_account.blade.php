                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                        ...
                                        <div class="form-group mb-0">
                                            ...
                                            <input type="text" class="date_range_picker form-control date_range_value"   id="date_range" name="date_range" placeholder="Select Date:"   autocomplete="off" value="{{ request()->get('date_range') ?? '' }}" autocomplete="off" placeholder="Date">
                                    ...
                                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 p-0">
                                        ...
                                        <div class="buttons">
                                            ...
                                            <input type="submit" class="btn btn-outline-info getDateRange" value="Search">&nbsp;
...
<script>
    function getAjaxDate(date_range = null ,get_serach_value = null){
        ...
        if(date_range != '')
            ...
            $.ajax({
                ...
                url:ajax_url,
                async: true,
                 data: {get_serach_value : get_serach_value , date_range : date_range},
...
<script type="text/javascript">
    $(document).on('click','.getDateRange',function(e){
        e.preventDefault();
        var date_range = $('.date_range_value').val();
        var get_serach_value = "";
        getAjaxDate(date_range , get_serach_value);
