...
@section('content')
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        <div class="buttons float-right float-md-left float-lg-left float-xl-right small-buttons mt-3 mb-3">
                            <!-- <a href="{{ route('downloadReport.pdf', 'solution') }}" class="btn btn-outline-info btn-bordered-primary">
    ...
    {{-- <section class="main-content">
        ...
        <div class="container">
            ...
            font-weight: 700;" id="totalDebtsAmount">Solution Report Summary

                    <span class="ml-1">
                        <a class="btn btn-default-outlined font-weight-bold" href="{{ route('downloadReport.pdf', 'solution') }}">
                        <i class="fa fa-file-pdf-o"></i>
                        Download PDF</a>
                        
                        <a class="btn btn-default-outlined font-weight-bold" href="{{ route('downloadReport.excel', 'solution') }}">
