    ...
    <section class="card-details">
        <div class="row">
            <div class="col-12 col-sm-12 col-md-12 col-lg-9 col-xl-12">
                <form id="agent_report_filter_form" action="{{ route('report.today_case_worked') }}" class="mb-0">
                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="buttons">
                                                ...
                                                <a href="{{ route('report.today_case_worked') }}" class="btn btn-outline-info">Clear</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-7 col-xl-12 p-md-0 p-lg-0">
                    <div class="buttons float-right float-lg-left float-md-left float-xl-right small-buttons mb-3 mt-3">
                       <a href="{{ route('downloadReport.excel', 'today_case_worked') }}" class="btn btn-outline-info btn-bordered-primary"> <i class="fa fa-file-excel"></i>&nbsp; Export Excel</a>
                    </div>
                </div>
            </div>
