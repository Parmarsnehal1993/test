...
<section class="main-content">
    ...
    <div class="row mt--100">
        <h1 id="totalDebtsAmount">Single DMP Agent Quality Score Report Total</h1>
    </div>
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 pr-0 mb-3">
                        <div class="buttons float-right float-md-left float-lg-left float-xl-right small-buttons">
                            <a href="{{ route('downloadReport.excel', ['get_single_dmp_agent_score_report_total' => 'get_single_dmp_agent_score_report_total','agent_id' => $data['agent_id']]) }}" class="btn btn-outline-info btn-bordered-primary">
                                <i class="fa fa-file-excel"></i>
                                &nbsp; Export Excel</a>
                        </div>
                    </div>
                </div>
                @include('reports.masters.__get_single_dmp_agent_score_report_total')
        </section>
        </div>
    </section>
    <style>
    ...
    <script>
        $('#get_single_dmp_agent_score_report_total').DataTable({
            searching: false,
            ordering: false
        });
