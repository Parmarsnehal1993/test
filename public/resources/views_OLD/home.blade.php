                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div style="padding:10px 0px;">
                            <div class="row">
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 small-select change-status width-auto">
                                    <div class="d-grid fr-5">
                                       <div class="d-flex align-items-center align-content-center status-update text-center br-right justify-content-center">
                                        &nbsp;
                                       </div>
                                       <div class="d-flex align-items-center align-content-center status-update text-center br-right justify-content-center">
                                        8am - 4pm
                                    ...
                                    <!-- Code to displaye the calendat week dynamically start -->
                                        ...
                                        <div class="d-grid fr-5">
                                           ...
                                           <!-- 8am - 4pm -->
                                           <div class="d-flex align-items-center align-content-center status-update text-center br-right justify-content-center">
                                            <span class="dot {{ $eightyFourClass }} select_agent_calendar_slot slot_{{ $allDaysValue.'84'.$loginUser->id }}" data-selected_day="{{ $allDaysValue }}" data-calendar_slot="{{ $allDaysValue.'84'.$loginUser->id }}" data-agent_id="{{ $loginUser->id }}" data-date="{{ $allDaysValue }}" data-day="{{ $allDaysValue }}" data-start_time="8 am" data-end_time="4 pm"></span>
                                           </div>
                                           <!-- 10am - 6pm -->
                                           <div class="d-flex align-items-center align-content-center status-update text-center br-right justify-content-center">
                                           <span class="dot {{ $oneZeoSixClass }} select_agent_calendar_slot slot_{{ $allDaysValue.'106'.$loginUser->id }}" data-selected_day="{{ $allDaysValue }}" data-calendar_slot="{{ $allDaysValue.'106'.$loginUser->id }}" data-agent_id="{{ $loginUser->id }}" data-date="{{ $allDaysValue }}" data-day="{{ $allDaysValue }}" data-start_time="10 am" data-end_time="6 pm"></span>
                                           </div>
                                           <!-- 12pm - 8pm -->
                                           <div class="d-flex align-items-center align-content-center status-update text-center br-right justify-content-center">
                                           <span class="dot {{ $oneTwoEightClass }} select_agent_calendar_slot slot_{{ $allDaysValue.'128'.$loginUser->id }}" data-selected_day="{{ $allDaysValue }}" data-calendar_slot="{{ $allDaysValue.'128'.$loginUser->id }}" data-agent_id="{{ $loginUser->id }}" data-date="{{ $allDaysValue }}" data-day="{{ $allDaysValue }}" data-start_time="12 pm" data-end_time="8 pm"></span>
                                           </div>
                                           <div class="d-flex align-items-center align-content-center status-update text-center br-right justify-content-center">
                                            <select  id="start_hour_{{ $allDaysValue.$loginUser->id }}" class="form-control start_custom_hour" placeholder="Start Hour" data-selected_day="{{ $allDaysValue }}" data-agent_id="{{ $loginUser->id }}" data-date="{{ $allDaysValue }}" data-day="{{ $allDaysValue }}">
                                                @php
                                                $splittedStartTime = '';
                                                $splittedEndTime = '';
                                                if($is_custom_date) {
                                                    ...
                                                    } else if(strlen($agentCalendarDetail[$loginUser->id][$allDaysValue]) == 3 || strlen($agentCalendarDetail[$loginUser->id][$allDaysValue]) == 4) {
                                                ...
                                                @for($startHour = 8;$startHour <=20; $startHour++)
                                                    ...
                                                    @if( $startHour >= 12)
                                                        @if($startHour != 12)
                                                            <option value="{{ ($startHour - 12). 'pm' }}" {{ $selectedStartTime }}>{{ ($startHour - 12).':00' }} PM</option>
                                                        @else
                                                            <option value="{{ $startHour.' pm' }}" {{ $selectedStartTime }}>{{ $startHour.':00' }} PM</option>
                                                        @endif
                                                    @else
                                                        <option value="{{ $startHour.' am' }}" {{ $selectedStartTime }}>{{ $startHour.':00' }} AM</option>
                                                    @endif
                                                @endfor
                                            </select>

                                            <select  id="end_hour_{{ $allDaysValue.$loginUser->id }}" class="form-control end_custom_hour" placeholder="Start Hour" data-selected_day="{{ $allDaysValue }}" data-agent_id="{{ $loginUser->id }}" data-date="{{ $allDaysValue }}" data-day="{{ $allDaysValue }}">
                                                ...
                                                @for($endHour = 8;$endHour <=20; $endHour++)
                                                    ...
                                                    @if( $endHour >= 12)
                                                        @if($endHour != 12)
                                                            <option value="{{ ($endHour - 12).' pm' }}" {{ $selectedEndTime }}>{{ ($endHour - 12) .':00'}} PM</option>
                                                        @else
                                                            <option value="{{ $endHour.' pm' }}" {{ $selectedEndTime }}>{{ $endHour.':00' }} PM</option>
                                                        @endif
                                                    @else
                                                        <option value="{{ $endHour. 'am' }}" {{ $selectedEndTime }} >{{ $endHour.':00' }} AM</option>
                                                    @endif
                                                @endfor
                                            </select>
                                           </div>
                                    ...
                                    <div class="clearfix mt-4 mb-3">
                                        <input type="submit" name="submit" data-toggle="collapse" value="Save" data-target="#{{ $loginUser->name }}" class="btn btn-outline-info float-right btn-large">
                                     </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-md-7 col-lg-7 col-xl-7">
                ...
                <div class="card">
                    <div>
                                ...
                                <div class="col-6">
                                    <form action="{{ route('home_post') }}" method="post">
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="form-group">
                                                    <select class="form-control" name="getagent" required>
                                                        @if(isset($getAgent) && !empty($getAgent))
                                                            ...
                                                            @endphp
                                                            <option value="{{ $getAgent }}">{{ $getUserType }}</option>
                                                       @else
                                            ...
                                            <div class="col-4">
                                                <div class="form-group">
                                                    <input type="submit" name="submit" class="btn btn-outline-info" value="Submit" style="font-size: 17px;">
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="row mt-5 ml-0 mr-0 theme-overflow existing_agent existing_agent-admin" style="height:auto;">
                                    ...
                                    <ul class="table-body align-items-center flex-wrap">
                                        ...
                                        <li>
                                            ...
                                            @elseif($getAgentListValue->user_type == 11) {{ 'Compliance Agent' }}
                                             ...
                                             @elseif($getAgentListValue->user_type == 12) {{ 'Marketing Agent' }}
                                    ...
                                    @endif --}}
                                        ...
                                        @if($getAgentListValue->user_type == 5 || $getAgentListValue->user_type == 6)
                                            <li>
                                                ...
                                                data-toggle="collapse" data-target="#{{ $getAgentListValue->name }}"
                                                 title="Edit"><img src="images/icons/Plus_Icon@2x.png" alt="Edit"/ class="img-fluid" width="30">
                                        ...
                                        @endif
                                        <li>
                                            <a class="edit-agent" data-id="{{ $getAgentListValue->id }}" data-name="{{ $getAgentListValue->name }}" data-email="{{ $getAgentListValue->email }}" data-user_type="{{ $getAgentListValue->user_type }}" data-ip_address="{{ $getAgentListValue->ip_address }}"><i class="fa fa-pencil" aria-hidden="true"></a></i>
                                        </li>
                                        <div class="collapse width-100" id="{{ $getAgentListValue->name }}" style="padding:0px 20px;">
                                            <div style="padding:10px 0px;">
                                                <div class="row">
                                                    
                                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 change-status">
                                                        <div class="d-grid fr-5">
                                                           <div class="d-flex align-items-center align-content-center status-update text-center br-right justify-content-center">
                                                            &nbsp;
                                                           </div>
                                                        ...
                                                        <!-- Code to displaye the calendat week dynamically start -->
                                                           ...
                                                           @else
                                                            ...
                                                            <div class="d-grid fr-5">
                                                               ...
                                                               <!-- 8am - 4pm -->
                                                               <div class="d-flex align-items-center align-content-center status-update text-center br-right justify-content-center">
                                                                <span class="dot {{ $eightyFourClass }} select_agent_calendar_slot slot_{{ $allDaysValue.'84'.$getAgentListValue->id }}" data-selected_day="{{ $allDaysValue }}" data-calendar_slot="{{ $allDaysValue.'84'.$getAgentListValue->id }}" data-agent_id="{{ $getAgentListValue->id }}" data-date="{{ $allDaysValue }}" data-day="{{ $allDaysValue }}" data-start_time="8 am" data-end_time="4 pm"></span>
                                                               </div>
                                                               <!-- 10am - 6pm -->
                                                               <div class="d-flex align-items-center align-content-center status-update text-center br-right justify-content-center">
                                                               <span class="dot {{ $oneZeoSixClass }} select_agent_calendar_slot slot_{{ $allDaysValue.'106'.$getAgentListValue->id }}" data-selected_day="{{ $allDaysValue }}" data-calendar_slot="{{ $allDaysValue.'106'.$getAgentListValue->id }}" data-agent_id="{{ $getAgentListValue->id }}" data-date="{{ $allDaysValue }}" data-day="{{ $allDaysValue }}" data-start_time="10 am" data-end_time="6 pm"></span>
                                                               </div>
                                                               <!-- 12pm - 8pm -->
                                                               <div class="d-flex align-items-center align-content-center status-update text-center br-right justify-content-center">
                                                               <span class="dot {{ $oneTwoEightClass }} select_agent_calendar_slot slot_{{ $allDaysValue.'128'.$getAgentListValue->id }}" data-selected_day="{{ $allDaysValue }}" data-calendar_slot="{{ $allDaysValue.'128'.$getAgentListValue->id }}" data-agent_id="{{ $getAgentListValue->id }}" data-date="{{ $allDaysValue }}" data-day="{{ $allDaysValue }}" data-start_time="12 pm" data-end_time="8 pm"></span>
                                                               </div>
                                                               <div class="d-flex align-items-center align-content-center status-update text-center br-right justify-content-center">
                                                                <select  id="start_hour_{{ $allDaysValue.$getAgentListValue->id }}" class="form-control start_custom_hour" placeholder="Start Hour" data-selected_day="{{ $allDaysValue }}" data-agent_id="{{ $getAgentListValue->id }}" data-date="{{ $allDaysValue }}" data-day="{{ $allDaysValue }}">
                                                                    @php
                                                                    $splittedStartTime = '';
                                                                    $splittedEndTime = '';
                                                                    if($is_custom_date) {
                                                                        ...
                                                                        } else if(strlen($agentCalendarDetail[$getAgentListValue->id][$allDaysValue]) == 3 || strlen($agentCalendarDetail[$getAgentListValue->id][$allDaysValue]) == 4) {
                                                                ...
                                                                <select  id="end_hour_{{ $allDaysValue.$getAgentListValue->id }}" class="form-control end_custom_hour" placeholder="Start Hour" data-selected_day="{{ $allDaysValue }}" data-agent_id="{{ $getAgentListValue->id }}" data-date="{{ $allDaysValue }}" data-day="{{ $allDaysValue }}">
                                                                    <option value="">Select End Hour</option>
                                                                    @for($endHour = 8;$endHour <=20; $endHour++)
                                                                        @php
                                                                            $selectedEndTime = '';
                                                        ...
                                                        <!-- Code to displaye the calendat week dynamically end -->
                                                        <div class="clearfix mt-4 mb-3">
                                                            <input type="submit" name="submit" data-toggle="collapse" value="Save" data-target="#{{ $getAgentListValue->name }}" class="btn btn-outline-info float-right btn-large">
                                                         </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    ...
                                    <form action="#" method="POST">
                                        ...
                                        <input type="hidden" id="hiddenAgentId" name="hiddenAgentId">
                                        <div class="form-group">
                                            <input type="text" id="name_user" name="name" class="form-control" placeholder="Name" required />
                                        ...
                                        <div class="form-group">
                                            <input type="password" id="password_user" name="password" class="form-control" placeholder="Password" required />
                                        </div>
                                        <div class="form-group">
                                            <input type="text" id="ip_address_user" name="ip_address" class="form-control" placeholder="IP Address" required pattern="((^|\.)((25[0-5])|(2[0-4]\d)|(1\d\d)|([1-9]?\d))){4}$" />
                                        </div>
                                        <div class="form-group">
                                            @if($loginUser->user_type == 1)
                                                <select id="user_type_add_user" name="user_type" class="form-control" placeholder="user Type" required>
                                                    <option value="1">Admin</option>
                                                    <option value="2">Debts Drafter</option>
                                                    <option value="3">Debts Advisor</option>
                                                    <option value="4">Report User</option>
                                        ...
                                        <div class="clearfix mt-2">
                                            ...
                                            <input type="submit" name="submit" value="Add Agent" class="btn btn-outline-info float-right btn-large add-agent">
...
$(document).on('click', '.select_agent_calendar_slot', function(){
    ...
    $.ajax({
        url:'{{ route('saveAgentCalendarDetails') }}',
        type:'post',
        data:{
                _token : '{{csrf_token()}}',
                agent_id : agent_id,
            ...
            for (var key in data){
                if (data.hasOwnProperty(key)) {
                    if(key=='inserted'){
                        ...
                        flag = 'insertFailed';
                        messageIcon = 'error';
                        message = 'Failed to insert this data.' + data[key] + ' Please try again.';
                    } else if(key=='deleted'){
                        flag = 'deleted';
                    } else if(key=='deletedFailed'){
                        flag = 'deletedFailed'
                        messageIcon = 'error';;
                        message = 'Failed to delete this data.' + data[key] + ' Please try again.';
                    }
                }
            }
            if(flag == 'inserted') {
                $('#start_hour_'+selected_day+agent_id).find('option:eq(0)').prop('selected', true);
                $('#end_hour_'+selected_day+agent_id).find('option:eq(0)').prop('selected', true);
                
                if($('.slot_'+selected_day+'84'+agent_id).hasClass(changeClass))
                    $('.slot_'+selected_day+'84'+agent_id).removeClass(changeClass).addClass(currentClass);
                if($('.slot_'+selected_day+'106'+agent_id).hasClass(changeClass))
                    $('.slot_'+selected_day+'106'+agent_id).removeClass(changeClass).addClass(currentClass);
                if($('.slot_'+selected_day+'128'+agent_id).hasClass(changeClass))
                    $('.slot_'+selected_day+'128'+agent_id).removeClass(changeClass).addClass(currentClass);
...
$(document).on('change', '.start_custom_hour, .end_custom_hour', function(){
    ...
    if(start_time != '' && end_time != '') {
        $.ajax({
            ...
            success:function(data){
                $('.slot_'+selected_day+'84'+agent_id).removeClass("dot-success").addClass("dot-danger");
                $('.slot_'+selected_day+'106'+agent_id).removeClass("dot-success").addClass("dot-danger");
                $('.slot_'+selected_day+'128'+agent_id).removeClass("dot-success").addClass("dot-danger");
            }
        });
    }
});
...
$(document).on('click','.add-agent',function(e){
    ...
    $.ajax({
        url : '{{ route('agent.save_agent') }}',
        method : 'post',
        data : { "_token": "{{ csrf_token() }}",get_ajax_call : get_ajax_call,name:name,email:email,password:password,ip_address:ip_address,user_type:user_type},
        dataType : 'json',
        success:function(data)
        {
            if(data == 'success'){
