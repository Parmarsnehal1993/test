            ...
            <div class="modal-content card card-secondary">
                <div class="modal-header">
                    ...
                    <button type="button" class="close alert_open" aria-label="Close">
                        <img src="{!! asset('images/icons/Cross_Icon@2x.png')!!}" alt="Close" class="img-fulid"
                            width="40"
                            height="40">
                    </button>
                </div>
                                ...
                                <div class="col-md-9">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                ...
                                                <hr>
                                                <h3>Dependents & Living Arrangements</h3>
                                                 <div class="form-group">
                                                <label for="who_do_you_live_with" style="margin-top: 12px;">Who do you Live with?:</label>
                                                    <select class="form-control" name="who_do_you_live_with" id="who_do_you_live_with">
                                                        <option>Select Any Option</option>
                                                        <option @if(isset($result->who_do_you_live_with) && $result->who_do_you_live_with == "alone") {{ 'selected' }} @endif value="alone">Alone</option>
                                                        <option @if(isset($result->who_do_you_live_with) && $result->who_do_you_live_with == "couple") {{ 'selected' }} @endif value="couple">Couple</option>
                                                    </select>
                                                </div>
                                                <div class="form-group">
                                        ...
                                        <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                            {{-- <form action="#">
                                                ...
                                                <div class="form-group" style="margin-top: 54px !important;">
                                               ...
                                               {{--  <div class="form-group">
                                                ...
                                                <hr>
                                                 <div class="form-group" style="margin-top:47px !important;">
...
$(document).on('click', '#update', function(e){
    ...
    var who_do_you_live_with = $('#who_do_you_live_with').find(":selected").val();
    alert(who_do_you_live_with);
