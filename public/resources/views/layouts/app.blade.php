    ...
    <div id="sidenav-overlay"></div>
        <div class="wrapper">
           ...
           @include('sidebar')
            ...
            <!-- exit modal -->
            <div id="exit_modal" class="modal fade show alert_modal close_exit_modal_div" tabindex="-1" role="dialog" aria-hidden="true">
...
<div id="view_pros_and_cons_list" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="my-modal-title">
    ...
    <div id="comapir_data_side_by_side" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="my-modal-title">
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content card card-secondary">
                    <div class="modal-header">
                        <button type="button" class="close alert_open close_reminder_popup">
