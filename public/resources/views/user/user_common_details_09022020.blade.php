                            ...
                            <div class="row m-0">
                                ...
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <div class="buttons mt-2">
                                        ...
                                        {{-- <button class="btn btn-outline-info" data-toggle="modal" data-backdrop="static" data-keyboard="false" data-target="#Sent_To_IVA_Modal">
                                        Send IVA Team
                                        </button> --}}
                                        <button class="btn btn-outline-info send_iva_team" data-toggle="modal" data-backdrop="static" data-keyboard="false" data-target="#Sent_To_IVA_Modal" data-user_id="{{ $userInfo->user_id }}" data-case_status="iva draft"> 
                                        Send IVA Team
                                        </button>
