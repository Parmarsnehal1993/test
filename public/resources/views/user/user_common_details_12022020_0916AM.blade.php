...
<div class="main-content pt-0">
                                    ...
                                    <form id="update_case_status_form" action="#" method="POST" class="display-ib">
                                        ...
                                        <ul class="navbar-nav footer-link">
                                            ...
                                            @if(in_array(strtolower($currentCaseStatusDay), $checkMessageDayDisplayArr) || in_array($currentCaseStatusDay, $messagedayarr))
                                                <li class="nav-item">
                                                    <a data-status="{{$data->id}}" class="changeday nav-link text-warning" data-change_case_status_name="{{ (!empty($currentCaseStatusDay) && in_array($currentCaseStatusDay, $messagedayarr)) ? $currentCaseStatusDay : 'messageday1' }}">
                                    ...
                                    <div class="buttons mt-2">
                                       ...
                                       <!-- Debt advisor code start -->
                                        @if($loginUser->user_type == 3)
                                            <button class="btn btn-outline-info send_iva_team" data-toggle="modal" data-backdrop="static" data-keyboard="false" data-target="#Sent_To_IVA_Modal" data-user_id="{{ $userInfo->user_id }}" data-title="IVA checklist" data-case_status="iva draft"> 
                                            Send IVA Team
                                            </button>
                                            <button class="btn btn-outline-info send_team_dmp" data-toggle="modal" data-backdrop="static" data-keyboard="false" data-target="#Sent_To_DMP_team_Modal" data-user_id="{{ $userInfo->user_id }}" data-title="DMP Checklist" data-case_status="Sent to DMP">
                                                Send DMP Team
                                            </button>
                                        @endif
                                        ...
                                        @if($loginUser->user_type == 5)
                                            {{-- <button class="btn btn-outline-info send_iva_team" data-target="#Sent_To_IVA_Modal" data-toggle="modal" data-backdrop="static" data-keyboard="false" data-user_id="{{ $userInfo->user_id }}" data-case_status="iva draft"> --}}
                                            <!-- #Sent_To_IVA_Modal -->
                                            {{-- Send IVA
                                            </button> --}}
                                            <button class="btn btn-outline-info send_iva_team" data-toggle="modal" data-target="#Sent_To_IVA_Modal" data-backdrop="static" data-keyboard="false" data-user_id="{{ $userInfo->user_id }}" data-title="IVA checklist" data-case_status="iva draft"> 
                                            Send IVA
                                            </button>
                                            
                                            <!-- open model sent_to_DMP_Model -->
                                            <button class="btn btn-outline-info send_dmp_provider_data" data-toggle="modal" data-backdrop="static" data-target="#Sent_To_DMP_Modal" data-keyboard="false" data-user_id="{{ $userInfo->user_id }}" data-case_status="SEND TO DMP PROVIDER" data-title="Send to DMP Provider">
                                                Send DMP Provider
                                            </button>
                                        @endif
    ...
    <div id="calender_modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="my-modal-title">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content card card-secondary">
                <div class="modal-header">
                    <div class="card-title">Reminder Date</div>
        ...
        <!-- common model pop up code start -->
            <div id="common_model_pop_up" class="modal  fade" tabindex="-1" role="dialog" aria-labelledby="my-modal-title">
                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                    <div class="modal-content card card-secondary">
                        <div class="modal-header">
      ...
      <div id="alert_modal alert_modal" class="modal fade show" tabindex="-1" role="dialog" aria-hidden="true">
                ...
                style="height: auto;min-height: auto !important;">
                        <div class="modal-content card card-secondary">
                            ...
                            <div class="modal-footer justify-content-start">
                                    ...
                                    <a  class="btn btn-outline-danger zcasetype_change_paid" style="padding: 10px 30px;">Paid</a>
            ...
            <div id="cancelled" class="modal fade show entercase" style="display:none" tabindex="-1" role="dialog" aria-labelledby="my-modal-title">
                ...
                style="height: auto;min-height: auto !important;">
                        <div class="modal-content card card-secondary">
                            ...
                            <div class="modal-footer justify-content-start">
                                    <div class="buttons width-100 justify-content-between">
                                    <a class="btn btn-outline-danger zcasetype_change_cancelled" style="padding: 10px 30px;">Cancelled</a>
                                    <a  class="btn btn-outline-primary" data-dismiss="modal" id="modal_hide">No</a>
                                </div>
                            </div>
                        </div>
                ...
                style="height: auto;min-height: auto !important;">
                        <div class="modal-content card card-secondary">
                            ...
                            <div class="modal-body justify-content-start" style="padding: 20px 20px 0px;">
                                ...
                                <input type="hidden" id="view_bottom_z_case_type_missed_payment" name="view_bottom_z_case_type_missed_payment" value="">
                                
                            </div>
                            <div class="modal-footer justify-content-start">
                                    <div class="buttons width-100 justify-content-between">
                                     <a  class="btn btn-outline-danger zcasetype_change_missed_payment" style="padding: 10px 30px;">Missed Payment</a>
                                    <a  class="btn btn-outline-primary" data-dismiss="modal" id="modal_hide">No</a>
                                </div>
                            </div>
                        </div>
...
<!-- To change the cancelled case status on click of view case bottom case link code start -->
    <script type="text/javascript">
        $(document).on('click', '.case_status_change_cancelled', function(){
            ...
            var z_case_status_value = $(this).data('zcasestatus');
            $('#view_bottom_z_case_type_cancelled').val(z_case_status_value);
...
<!-- To change the miss payment case status on click of view case bottom case link code start -->
    <script type="text/javascript">
        $(document).on('click', '.case_status_change_missed_payment', function(){
            $('#view_bottom_z_case_type_missed_payment').val('');
            var z_case_status_value = $(this).data('zcasestatus');
            $('#view_bottom_z_case_type_missed_payment').val(z_case_status_value);
            $('#miss_payments').modal('show');
        });
        $(document).on('click','.zcasetype_change_missed_payment', function () {
            var change_case_status_missed_payment_value = $('#view_bottom_z_case_type_missed_payment').val();
            //var case_status_name = $(this).text();
            var userId = $('#userId').val();
            ...
            $.ajax({
                url:'{{ route('user.update_case_status') }}',
                method:'post',
                data:{_token: '{{csrf_token()}}',case_status_name:change_case_status_missed_payment_value,userId:userId},
                dataType:'json',
                success:function(data)
                {
                    var messageIcon = 'error';
...
<!-- To change the miss payment case status on click of view case bottom case link code end -->
