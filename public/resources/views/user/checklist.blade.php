                                        ...
                                        <tbody id="dynamic_checklist_data">
                                            ...
                                            @endif
                                             @php
                                                ...
                                                $pathPdf = public_path('truelayer/');
                                                $pdfCount = 1;
                                                
                                            @endphp
                                            
                                            {{-- @if($checkUserBankStatement)
                                                @foreach($checklist_pdf as $checkListPdfKey => $checkListPdfValue)
                                                    
                                                    <tr>
                                                        <td>PDF {{ $pdfCount }}</td>
                                                        <td>BANK STATEMENT</td>
                                                        <td></td>
                                                        <td><a href="https://freezecms.co.uk/public/truelayer/{{ $checkListPdfValue->file }}.pdf" class="text-info" download><img src="https://freezecms.co.uk/public/images/sunglasees.png" width="30" alt="sunglasees" /></a>
                                                        </td>
                                                        <td>-</td>
                                                    </tr>
                                                    @php  $pdfCount++ @endphp
