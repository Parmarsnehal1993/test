                        ...
                        <div class="row">
                                        ...
                                        <div class="row mt-0">
                                            <div class="" style="padding-right: 30px;width: 100%;">
                                                <ul class="table-body align-items-center flex-wrap outgoing-data">
                                                    <li>
                                                        Essential Expediture
                                                    </li>
                                                    <li>
                                                        <span style="margin-top:5px;">
                                                        total:&#163;    
                                                        </span>
                                                        <span class="essential_expediture"> {{ $total_essential_expediture }}</span>
                                                    ...
                                                    <div id="housing_collapse" class="collapse scroll-y">
                                                        <div class="row">
                                                            <div class="col-md-9">
                                                             ...
                                                             <span style="margin-top: 10px;color: gray;font-size: 12px;">Bank <br>Statement</span>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-9">
                                                                ...
                                                                <input type="text" name="" value="{{ $do_you_have_secured_loan }}" class="form-control" id="essential_expediture4"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-9">
                                                                <span>Mortgage Endowment/PPI</span>
                                                                <input
                                                                    type="text"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-9">
                                                                ...
                                                                <input type="text" class="form-control" name="do you have any appliances or furniture on rent?" id="essential_expediture7" value="{{ $life_insurance }}">
                                                        ...
                                                        <div class="row">
                                                         ...
                                                         <div class="row">
                                                            ...
                                                            <span style="margin-top: 10px;color: gray;font-size: 12px;">Max <br>£87</span>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-9">
                                                                <span>Electricity
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <span style="margin-top: 10px;color: gray;font-size: 12px;">250</span>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-9">
                                                                <span>Child Care
                                                ...
                                                <ul class="table-body align-items-center flex-wrap outgoing-data">
                                                    ...
                                                    @php 
                                                        $housing_rules_count_server = 0;
                                                    @endphp
                                                    <li><span style="margin-top:5px;">
                                                        total:&#163;    
                                                        </span><span class="house_keeping_total">{{ $totalHousKeeping }}</span>
                                                        <a href="#" data-toggle="collapse" data-target="#utilities_collapse" id="house_keeping_collapse">
                                                        <img
                                                            src="{!! asset('images/icons/Plus_Icon@2x.png')!!}"
                                                            alt="Plus"
                                                            class="img-fluid"
                                                    ...
                                                    <div id="utilities_collapse" class="collapse scroll-y">
                                                        <div class="row">
                                                            @php 
                                                                $getHouseKeepingFoodRules = getHouseKeepingRules('Food & Toiletries',$who_do_you_live_with,$total_child);
                                                                $getFoodToiletriesValue = checkOutgoingRuleValue($getHouseKeepingFoodRules , $food_toiletries);
                                                                
                                                            @endphp
                                                            <div class="col-md-9 housing_rule">
                                                                <span>Food & Toiletries
                                                                </span>
                                                                <input type="text" id="house_keeping1" name="Food & Toiletries" class="form-control" value="{{ $food_toiletries }}">
                                                            </div>
                                                             <span style="margin-top: 10px;color: gray;font-size: 12px;">{{ $getHouseKeepingFoodRules }}</span>
                                                        </div>
                                                        
                                                        
                                                        <div class="row">
                                                            @php 
                                                                $getHouseKeepingNewsPaperRules = getHouseKeepingRules('Newspappers / Magazine',$who_do_you_live_with,$total_child);
                                                                $getNewsPaperValue = checkOutgoingRuleValue($getHouseKeepingNewsPaperRules , $newspappers_magazine);
                                                            @endphp
                                                            <div class="col-md-9 housing_rule">
                                                                <span>Newspappers / Magazine
                                                                </span>
                                                                <input type="text" name="Newspappers / Magazine" id="house_keeping2" class="form-control" value="{{ $newspappers_magazine }}">
                                                            </div>
                                                            <span style="margin-top: 10px;color: gray;font-size: 12px;">{{ $getHouseKeepingNewsPaperRules }}</span>
                                                        </div>
                                                        <div class="row">
                                                            @php 
                                                                $getHouseKeepingTabaccoRules = getHouseKeepingRules('Tabacco',$who_do_you_live_with,$total_child);
                                                                $getTabaccoValue = checkOutgoingRuleValue($getHouseKeepingTabaccoRules , $tabacco);
                                                            @endphp
                                                            <div class="col-md-9 housing_rule">
                                                                <span>Tabacco
                                                                </span>
                                                                <input type="text" id="house_keeping3" name="Tabacco" class="form-control" value="{{ $tabacco }}">
                                                            </div>
                                                            <span style="margin-top: 10px;color: gray;font-size: 12px;">{{ $getHouseKeepingTabaccoRules }}</span>
                                                        </div>
                                                        <div class="row">
                                                            @php 
                                                                $getHouseKeepingLaundryRules = getHouseKeepingRules('Laundry',$who_do_you_live_with,$total_child);
                                                                $getLaundryValue = checkOutgoingRuleValue($getHouseKeepingLaundryRules , $laundry);
                                                            @endphp
                                                            <div class="col-md-9 housing_rule">
                                                                <span>Laundry
                                                                </span>
                                                                <input type="text" id="house_keeping4" name="Laundry" class="form-control" value="{{ $laundry }}">
                                                            </div>
                                                            <span style="margin-top: 10px;color: gray;font-size: 12px;">{{ $getHouseKeepingLaundryRules }}</span>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-9 housing_rule">
                                                                <span>Clothing & Footwear
                                                                </span>
                                                                <input type="text" id="house_keeping5" name="Clothing & Footwear" class="form-control" value="{{ $clothing_footwear }}">
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-9 housing_rule">
                                                                ...
                                                                <input type="text" id="house_keeping6" name="Nappies & Baby Items" class="form-control" value="{{ $nappies_baby_items }}">
                                                            </div>
                                                             <span style="margin-top: 10px;color: gray;font-size: 12px;">Bank <br>Statement</span>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-9 housing_rule">
                                                                ...
                                                                <input type="text" id="house_keeping7" name="Pet Food" class="form-control" value="{{ $pet_food_housing }}">
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-9 housing_rule">
                                                                ...
                                                                <input type="text" id="house_keeping8" name="Other" class="form-control" value="{{ $other_housing }}">
                                                            </div>
                                                            {{-- {{ dd($getFoodToiletriesValue , $getNewsPaperValue , $getTabaccoValue , $getLaundryValue) }} --}}
                                                            <span style="margin-top: 10px;color: gray;font-size: 12px;">Bank <br>Statement</span>
                                                ...
                                                <ul class="table-body align-items-center flex-wrap outgoing-data">
                                                    ...
                                                    <li><span style="margin-top:5px;">
                                                        total:&#163;    
                                                        </span><span class="phone_total">{{ $totalphone }}</span>
                                                    ...
                                                    <div id="Communications_collapse" class="collapse scroll-y">
                                                        ...
                                                        <div class="row">
                                                             @php 
                                                                $getPhoneRules = getPhoneRules('Mobile Phone',$who_do_you_live_with,$total_child);
                                                                $getPhoneValue = checkOutgoingRuleValue($getPhoneRules , $mobile_phone);
                                                                
                                                            @endphp
                                                            <div class="col-md-9 phone_rule">
                                                                <span>Mobile Phone
                                                                </span>
                                                                <input
                                                                    type="text"
                                                            ...
                                                            <span style="margin-top: 10px;color: gray;font-size: 12px;">{{ $getPhoneRules }}</span>
                                                        </div>
                                                ...
                                                <ul class="table-body align-items-center flex-wrap outgoing-data">
                                                    ...
                                                    <span style="margin-top:5px;">
                                                        total:&#163;    
                                                        </span><span class="travel">{{ $totalTravel }}</span>
                                                    ...
                                                    <div id="travel_collapse" class="collapse scroll-y">
                                                        <div class="row">
                                                             @php 
                                                                $getPublictranportRules = getTravelRules('Public Transport (inc Taxis)',$who_do_you_live_with,$total_child);
                                                                
                                                                $getTransportValue = checkOutgoingRuleValue($getPublictranportRules , $public_transport_inc_taxis);
                                                               
                                                            @endphp
                                                            <div class="col-md-9 travel_rule">
                                                             ...
                                                             <span style="margin-top: 10px;color: gray;font-size: 12px;">{{ $getPublictranportRules }}</span>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-9">
                                                                <span>Car Insurance
                                                        ...
                                                        <div class="row">
                                                            @php 
                                                                $getFuleRule = getTravelRules('Fuel (Petrol, Diesel, ect)',$who_do_you_live_with,$total_child);
                                                            ...
                                                            <span style="margin-top: 10px;color: gray;font-size: 12px;">{{ $getFuleRule }}</span>
                                                        </div>
                                                        {{-- <div class="row">
                                                            <div class="col-md-9">
                                                        ...
                                                        <div class="row">
                                                            @php 
                                                                $getMotRule = getTravelRules('MOT & Maintenance',$who_do_you_live_with,$total_child);
                                                            ...
                                                            <span style="margin-top: 10px;color: gray;font-size: 12px;">{{ $getMotRule }}</span>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-9">
                                                                 <span>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            {{-- {{ dd($getTransportValue, $getFuelValue , $getMotValue) }} --}}
                                                            <div class="col-md-3">
                                                                <button
                                                                    href="javascipt:void(0)"
                                                                    id="transport"
                                                ...
                                                <ul class="table-body align-items-center flex-wrap outgoing-data">
                                                    ...
                                                    <li>
                                                        <span style="margin-top:5px;">
                                                        total:&#163;    
                                                        </span><span class="other_exp">{{ $totalotherExp }}</span>
                                                    ...
                                                    <div id="food_collapse" class="collapse scroll-y">
                                                        <div class="row">
                                                            @php 
                                                                $getHelthRule = getOtherExpRules('Health ( Dentist & Glasses)',$who_do_you_live_with,$total_child);
                                                                $getHealthValue = checkOutgoingRuleValue($getHelthRule , $health_dentist_glasses);
                                                            @endphp
                                                            <div class="col-md-9 other_exp_rules">
                                                            ...
                                                            <span style="margin-top: 10px;color: gray;font-size: 12px;">{{ $getHelthRule }}</span>
                                                        </div>
                                                        <div class="row">
                                                            @php 
                                                                $getMedicineRule = getOtherExpRules('Medicine',$who_do_you_live_with,$total_child);
                                                            ...
                                                            <div class="col-md-9 other_exp_rules">
                                                             ...
                                                             <span style="margin-top: 10px;color: gray;font-size: 12px;">{{ $getMedicineRule }}</span>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-9">
                                                        ...
                                                        <div class="row">
                                                             @php 
                                                                $getHairDressingRule = getOtherExpRules('Hairdressing / Haircuts',$who_do_you_live_with,$total_child);
                                                            ...
                                                            <span style="margin-top: 10px;color: gray;font-size: 12px;">{{ $getHairDressingRule }}</span>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-9">
                                                        ...
                                                        <div class="row">
                                                            @php 
                                                                $getWorkMealRule = getOtherExpRules('Work Meals',$who_do_you_live_with,$total_child);
                                                            ...
                                                            <span style="margin-top: 10px;color: gray;font-size: 12px;">{{ $getWorkMealRule }}</span>
                                                        </div>
                                                        <div class="row">
                                                            @php 
                                                                $getSchoolMealRule = getOtherExpRules('School Meals',$who_do_you_live_with,$total_child);
                                                            ...
                                                            <span style="margin-top: 10px;color: gray;font-size: 12px;">{{ $getSchoolMealRule }}</span>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-9 other_exp_rules">
                                                                 @php 
                                                                $getPocktMoneyRule = getOtherExpRules('Pocket Money',$who_do_you_live_with,$total_child);
                                                                ...
                                                                <input
                                                                    type="text"
                                                                    name="Pocket Money"
                                                                    class="other_exp8 form-control"
                                                                    placeholder="1800"
                                                                    value="{{ $pocket_money }}">
                                                            </div>
                                                            <span style="margin-top: 10px;color: gray;font-size: 12px;">{{ $getPocktMoneyRule }}</span>
                                                        </div>
                                                         <div class="row">
                                                            @php 
                                                                $getSchooltripRule = getOtherExpRules('School Trips',$who_do_you_live_with,$total_child);
                                                            ...
                                                            <span style="margin-top: 10px;color: gray;font-size: 12px;">{{ $getSchooltripRule }}</span>
                                                        </div>
                                                        <div class="row">
                                                            @php 
                                                                $getHobbieSportRule = getOtherExpRules('Hobbies / Sport',$who_do_you_live_with,$total_child);
                                                            ...
                                                            <span style="margin-top: 10px;color: gray;font-size: 12px;">{{ $getHobbieSportRule }}</span>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-9">
                                                                <span>
                                                        ...
                                                        <div class="row">
                                                            @php 
                                                                $getSundriesRule = getOtherExpRules('Sundries & Emergency',$who_do_you_live_with,$total_child);
                                                            ...
                                                            <span style="margin-top: 10px;color: gray;font-size: 12px;">{{ $getSundriesRule }}</span>
                                                        </div>
                                                         <div class="row">
                                                            <div class="col-md-9">
                                                                <span>
                            ...
                            <div class="col-md-4">
                                <table class="table mb-0 text-right text-primary td-p-0">
                                    <tbody>
                                        <tr>
                                            <td>ESSENTIAL EXPEDITURE:</td>
                                            <td>&#163;<span id="essential_expediture" class="essential_expediture">{{ $total_essential_expediture }}</span></td>
                                        </tr>
                                        <tr>
                                            <td>HOUSEKEEPING:</td>
                                            <td>&#163;<span id="house_keeping_id" class="house_keeping_total">{{ $totalHousKeeping }}</span></td>
                                        </tr>
                                        <tr>
                                            <td>PHONE:</td>
                                            <td>&#163;<span id="phone_total_id" class="phone_total">{{ $totalphone }}</span></td>
                                        </tr>
                                        <tr>
                                            <td>TRAVEL:</td>
                                            <td>&#163;<span id="travel_id" class="travel_total">{{ $totalTravel }}</span></td>
                                        </tr>
                                        <tr>
                                            <td>OTHER EXP:</td>
                                            <td>&#163;<span id="other_exp_id" class="other_exp">{{ $totalotherExp }}</span></td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h3>&#163;<span class="outgoing_total">{{ $total_essential_expediture + $totalHousKeeping + $totalphone + $totalTravel + $totalotherExp }}</span></h3>
                                            </td>
                                        </tr>
                                        @php
                                        ...
                                        <tr>
                                            <td>POTENTIAL DEBT WRITTEN OFF:</td>&nbsp;&nbsp;
                                            <td>&#163; {{ $potential_debt_written_off }}</td>
                                        </tr>
                                        <tr>
                                            <td>FEES:</td>&nbsp;&nbsp;
                                            <td>&#163; {{ $fees }}</td>
                                        ...
                                        <tr>
                                            <td>PAID TO CREDITORS:</td>&nbsp;&nbsp;
                                            <td>&#163; {{ $paid_to_creditor }}</td>
                                        </tr>
                                        <tr>
                                            <td>DIVIDEND:</td>
                               ...
                               <div class="modal-footer mt-5 mb-4">
                                    <a href="{{ route('Export_pdf_file_outgoing', ['userId' => $userInfo->user_id]) }}" class="btn btn-outline-info float-right btn-large">Export</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    var housing_rules_count = 0;
    $('.housing_rule input').on('change',function(){
        $('#housing').attr('disabled','true');
        ...
        $.ajax({
            ...
            success : function(data)
            {
                ...
                console.log(housing_rules_count);
                if(housing_rules_count === 4){
                    $('#housing').removeAttr("disabled");
    ...
    var phone_rules_count = 0;
    $('.phone_rule input').on('change',function(){
    ...
    var transport_rules_count = 0;
    $('.travel_rule input').on('change',function(){
            ...
            success : function(data)
            {
                if(Array.isArray(data)){
                     if(value < data[0]){
                        ...
                        transport_rules_count++;
                    }
                }else{
                     data = data.replace('£','');
                        if(data == "130" || data == "111"){
                            if(value < data || value > data){
                                alert('Please enter'+data);
                            }else{
                                transport_rules_count++;
                ...
                console.log(transport_rules_count);
                if(transport_rules_count === 3){
        ...
        var other_exp_rules_count = 0;
        $('.other_exp_rules input').on('change',function(){
        $('#other_exp').attr('disabled','true');
        var question = $(this).attr('name');
        var who_do_you_live_with = '<?php echo $who_do_you_live_with; ?>';
        var total_child = '<?php echo $total_child; ?>'; 
        var value = $(this).val();
            ...
            success : function(data)
            {
                ...
                if(Array.isArray(data)){
                    ...
                    if(value < data[0]){
                        ...
                        other_exp_rules_count++;
                    }
                }else{
                     data = data.replace('£','');
                     if(data == "111" || data == "11" || data == "44" || data == "20" || data == "30" || data == "40" || data == "50" || data == "60" || data == "70" || data == "80" || data == "90" || data == "10" || data == "88" || data == "52" || data == "104" || data == "156" || data == "208" || data == "260" || data == "13" || data == "26" || data == "39" || data == "65" || data == "64"){
                            if(value < data || value > data){
                                alert('Please enter'+data);
                            }else{
                                other_exp_rules_count++;
                ...
                console.log(other_exp_rules_count);
                if(other_exp_rules_count == 9){
                    $('#other_exp').removeAttr('disabled');
                }
            }
        })
    });
    ...
    $(document).on('click','#essential_expediture',function(e){
            ...
            $.ajax({
                url:'{{route('user.update_user_outgoing_essential_expediture')}}',
                method:'post',
                dataType: 'json',
                data:{
                        '_token':'{{ csrf_token() }}',
