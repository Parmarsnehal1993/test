                        ...
                        <div class="card height-auto" style="min-height: 200px !important;">
                            ...
                            <div class="card-body height-auto">
                                ...
                                <a
                                    ...
                                    <h1 class="text-center height-auto line-height-auto mb-4 mt-4">{{ $totalIvaCount ? $totalIvaCount : 0 }}</h1>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="card height-auto" style="min-height: 200px !important;">
                            ...
                            <div class="card-body height-auto">
                                ...
                                <a
                                    ...
                                    <h1 class="text-center height-auto line-height-auto mb-4 mt-4">{{ $totalTrustDeedCount ? $totalTrustDeedCount : 0 }}</h1>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="card height-auto" style="min-height: 200px !important;">
                            ...
                            <div class="card-body height-auto">
                                ...
                                <a
                                    ...
                                    <h1 class="text-center height-auto line-height-auto mb-4 mt-4">{{ $totalDasCompleteCount ? $totalDasCompleteCount : 0 }}</h1>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="card height-auto" style="min-height: 200px !important;">
                            ...
                            <div class="card-body height-auto">
                                ...
                                <a
                                    ...
                                    <h1 class="text-center height-auto line-height-auto mb-4 mt-4">{{ $totalQuickReviewCount ? $totalQuickReviewCount : 0 }}</h1>
                                </a>
                            </div>
                        </div>
                         ...
                         <div class="card height-auto" style="min-height: 200px !important;">
                            ...
                            <div class="card-body height-auto">
                                ...
                                <a
                                    ...
                                    class="statistics columnAjax d-block"
                                    data-type="web">
                                    <h1 class="text-center height-auto line-height-auto mb-4 mt-4">{{ $totalWebCount ? $totalWebCount : 0 }}</h1>
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 text-center">
                                        <a
                                            href="javascript:void(0)"
                                            class="statistics columnAjax d-block text-center"
                                            data-type="Awaiting Docs-overdue">
                                            <h1 class="text-danger">{{ $getAwaitingDocsoverdue ? $getAwaitingDocsoverdue : 0 }}</h1>
                                        </a>
                                        <p class="text-danger">
                                            overdue
                                        </p>
                        ...
                        <div class="card height-auto" style="min-height: 200px !important;">
                            ...
                            <div class="card-body height-auto">
                                ...
                                <a
                                    ...
                                    <h1 class="text-center height-auto line-height-auto mb-4 mt-4">{{ $totalDmpCompleteCount ? $totalDmpCompleteCount : 0 }}</h1>
                                </a>
                            </div>
                        </div>
                        <div class="card height-auto" style="min-height: 195px !important;">
                            ...
                            <div class="card-body height-auto">
                                ...
                                <a
                                    ...
                                    <h1 class="text-center height-auto line-height-auto mb-4 mt-4">{{ $totalOtherZcaseTypeCount ? $totalOtherZcaseTypeCount : 0 }}</h1>
                                </a>
                            </div>
                        </div>
                        <div class="card section-height-auto height-auto" style="min-height: 200px !important;">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table search-table text-left awaiating-table">
                                                    ...
                                                    @foreach($topMonthAgent['finalTopArr'] as $topMonthAgentKey => $topMonthAgentValue)
                                                        <tr>
                                                            <td>{{ $topCounter }}</td>
                                                            <td>{{ (isset($topMonthAgent['userArray']) && isset($topMonthAgent['userArray'][$topMonthAgentKey])) ? $topMonthAgent['userArray'][$topMonthAgentKey] : '-' }}</td>
                                ...
                                <div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-4">
                                    ...
                                    <table class="table text-primary">
                                        <tbody>
                                            <tr>
                                                <td>Introduction</td>
                                                <td id="introduction_count_get">{{ $agent_advisor_graph['introduction_count'] }}%</td>
                                            </tr>
                                            <tr>
                                                <td>Vulnerability</td>
                                                <td id="vulnerability_count_get">{{ $agent_advisor_graph['vulnerability_count'] }}%</td>
                                            </tr>
                                            <tr>
                                                <td>Fact find</td>
                                                <td id="fact_find_count_get">{{ round($agent_advisor_graph['fact_find_count']) }} %</td>
                                            </tr>
                                            <tr>
                                                <td>Solution</td>
                                                <td id="solution_count_get">{{ $agent_advisor_graph['solution_count'] }} %</td>
                                            </tr>
                                            <tr>
                                                <td>Documentation</td>
                                                <td id="documentation_count_get">{{ $agent_advisor_graph['documentation_total'] }} %</td>
                                            </tr>
                                            <tr>
                                                <td>Confirmation of sale</td>
                                                <td id="confirmation_count_get">{{ $agent_advisor_graph['confirmation_total'] }} %</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <div class="card-title">
                                    ...
                                    <form>
                                        <input type="hidden" name="introduction_get_graph_data" id="introduction_get_graph_data" value="">
                                        <input type="hidden" name="vulnerability_get_graph_data" id="vulnerability_get_graph_data" value="">
                                        <input type="hidden" name="fact_find_get_graph_data" id="fact_find_get_graph_data" value="">
                                        <input type="hidden" name="solution_get_graph_data" id="solution_get_graph_data" value="">
                                        <input type="hidden" name="documentation_get_graph_data" id="documentation_get_graph_data" value="">
                                        <input type="hidden" name="confirmation_get_graph_data" id="confirmation_get_graph_data" value="">
                                    </form>
                                </div>
                                @else 
                                @endif
