                            ...
                            <div class="row">
                                <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">  
                                    ...
                                    <div class="form-group form-inline outgoing_rules">
                                        ...
                                        <select name="" id="essential_expediture4" class="form-control outgoing_rules" data-type="ESSNTIAL EXPEDITURE" 
                                        data-key="Do You Have Secured Loan?" name="DO YOU HAVE SECURED LOAN?">
                                ...
                                <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                    ...
                                    @php
                                        ...
                                        $fees = getFeeValue($userInfo->user_id);
...
<script type="text/javascript">
    ...
    $('.outgoing_rules').on('change',function(e){
      e.preventDefault();      
