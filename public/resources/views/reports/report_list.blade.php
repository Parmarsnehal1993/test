...
@endphp
            ...
            <main class="main-content">
                ...
                <section class="card-section reports-cards">
                    <!-- Report Card -->
                    @if($loginUser->user_type == 8 || $loginUser->user_type == 12)
                     <div class="row">
                    @else
                    <div class="row">
                    ...
                    <div class="row ml--30">
                        ...
                        @else
                         <div class="col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3">
                            <div class="card text-center height-auto font-weight-bold">
                                ...
                                <div class="card-body">
                                    <div class="d-inline-block mr-2">
                                        <a href="{{route('report.total_debt_by_type')}}" class="no-underline"><i class="fa fa-file-pdf"></i>
                                        <h6>DOWNLOAD</h6></a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3">
                            <div class="card text-center height-auto font-weight-bold">
                                <div class="card-title">
                                    Total Debt Written Off By Type
                                </div>
                                <div class="card-body">
                                    <div class="d-inline-block mr-2">
                                        <a href="{{route('report.total_debt_written_off_by_type')}}" class="no-underline"><i class="fa fa-file-pdf"></i>
                                        <h6>DOWNLOAD</h6></a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3">
                            <div class="card text-center height-auto font-weight-bold">
                                <div class="card-title">
                                    Total Debt by written off report
                                </div>
                                <div class="card-body">
                                    <div class="d-inline-block mr-2">
                                        <a href="{{route('report.total_debt_by_written_offs_month')}}" class="no-underline"><i class="fa fa-file-pdf"></i>
                                        <h6>DOWNLOAD</h6></a>
                                    </div>
                                </div>
                            </div>
