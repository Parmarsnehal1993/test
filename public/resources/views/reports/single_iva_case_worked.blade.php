...
<section class="main-content">
    ...
    <div class="row mt--100">
        <h1 id="totalDebtsAmount">Single Iva Case worked</h1>
    </div>
        ...
        <div class="row mt-5">
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-6">
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        <form action="{{ route('report.single_iva_case_worked') }}" method="post">
                        @csrf
                            <div class="row">
                                <div class="col-6">
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 pr-0 mb-3">
                <div class="buttons float-right float-md-left float-lg-left float-xl-right small-buttons">
                    <a href="{{ route('downloadReport.excel', ['single_iva_case_worked' => 'single_iva_case_worked','agent_id' => $data['getSingleAgentData']['agent_id']]) }}" class="btn btn-outline-info btn-bordered-primary"><i class="fa fa-file-excel"></i>&nbsp; Export Excel</a>
                </div>
            </div>
        </div>
        @include('reports.masters.__single_iva_case_worked')
    </section>
</section>
<script>
    $('#single_iva_case_worked').DataTable({
        searching: false,
        ordering: false
    });
