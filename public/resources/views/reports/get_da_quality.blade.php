...
<section class="main-content">
                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-6">
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                <form action="{{ route('report.Da_agent_quality_report') }}" class="mb-0">
                                    <div class="row">
                                        <div class="col-6">
                                        ...
                                        <div class="col-6">
                                            <div class="buttons">
                                                ...
                                                <a href="{{ route('report.Da_agent_quality_report') }}" class="btn btn-outline-info">Clear</a>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <select class="form-control mb-3" name="get_da_agent">
                                             ...
                                             @foreach($data['allAgentDa'] as $key => $value)
            ...
            <div class="col-12 col-sm-12 col-md-7 col-lg-7 col-xl-12">
                <div>
                    <div class="buttons float-right float-lg-left float-md-left float-xl-right small-buttons mb-3 mt-3">
                        ...
                        <a href="{{route('downloadReport.excel' , 'get_da_quality')}}" class="btn btn-outline-info btn-bordered-primary">
                ...
                @include('reports.masters.__get_da_quality')
        </section>
        </div>
    ...
    <script>
        ...
        $('#get_da_quality_score').DataTable({
            searching: false,
            ordering: false
        });
