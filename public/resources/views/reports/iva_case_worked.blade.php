...
<section class="main-content">
    ...
    <div class="row mt--100">
        <h1 id="totalDebtsAmount">Iva Case worked</h1>
    </div>
    <section class="card-details">
                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-6">
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                <form action="{{ route('report.iva_case_worked') }}" class="mb-0">
                                    <div class="row">
                                        <div class="col-6">
                                        ...
                                        <div class="col-6">
                                            <div class="buttons">
                                                ...
                                                <a href="{{ route('report.iva_case_worked') }}" class="btn btn-outline-info">Clear</a>
            ...
            <div class="col-12 col-sm-12 col-md-7 col-lg-7 col-xl-12">
                <div>
                    <div class="buttons float-right float-lg-left float-md-left float-xl-right small-buttons mb-3 mt-3">
                        ...
                        <a href="{{route('downloadReport.excel' , 'iva_case_worked')}}" class="btn btn-outline-info btn-bordered-primary">
        ...
        @include('reports.masters.__iva_case_worked')
    </section>
</section>
    <script>
        $('#iva_case_worked_case').DataTable({
            searching: false,
            ordering: false
        });
