...
<section class="main-content">
        <div class="row mt--100">
            <h1 id="totalDebtsAmount">IVA Agent Quality Score Report Total</h1>
        </div>
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-9 col-xl-12">
                    <div class="row">
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-6">
                            <div class="row">
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <form action="{{ route('report.iva_quality_average_score') }}" class="mb-0">
                                        <div class="row">
                                            <div class="col-6">
                                            ...
                                            <div class="col-6">
                                                <div class="buttons">
                                                    ...
                                                    <a href="{{ route('report.iva_quality_average_score') }}" class="btn btn-outline-info">Clear</a>
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-6">
                            <div class="row">
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <form action="{{ route('report.single_iva_quality_average_score')  }}" class="mb-0" method="post">
                                        @csrf
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="form-group mb-0">
                ...
                <div class="col-12 col-sm-12 col-md-7 col-lg-7 col-xl-12">
                    <div>
                        <div class="buttons float-right float-lg-left float-md-left float-xl-right small-buttons mb-3 mt-3">
                            <a href="{{route('downloadReport.excel' , 'get_iva_agent_score_report_total')}}" class="btn btn-outline-info btn-bordered-primary"><i class="fa fa-file-excel"></i>&nbsp; Export Excel</a>
                        </div>
                    </div>
                </div>
            </div>
            @include('reports.masters.__get_iva_agent_score_report_total')
        </section>
</section>
    <script>
        $('#get_iva_agent_quality_score_report_total').DataTable({
            searching: false,
            ordering: false
        });
