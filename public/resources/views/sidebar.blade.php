...
@if($loginUser->user_type == 3 || $loginUser->user_type == 1 || $loginUser->user_type == 5 || $loginUser->user_type == 7 || $loginUser->user_type == 8 )
...
@else
<nav class="navbar fixed-left  d-table">
    <h1 class="font-h1 d-table-cell transform-center">
        <strong>Case:</strong>
        <span class="font-light">{{$userInfo->name}}</span>
    </h1>
</nav>
...
@elseif($loginUser->user_type == 1 || $loginUser->user_type == 9 || $loginUser->user_type == 10)
<nav class="navbar fixed-left  justify-content-center">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link profile" href="{{route('agent.view_calender_profile')}}" title="Profile_calender">
                            <img src="{!! asset('images/icons/calendarinfo_Icon@2x.png') !!}" alt="Workflow">
                        </a>
                    </li>
                    @endif
                    ...
                    <li class="nav-item"> 
                        <a class="nav-link" href="{{ route('completed_list') }}" title="Completed List">
                            <img src="{!! asset('images/icons/Completed_List_Icon@2x.png') !!}" alt="Completed List">
                        </a>
                    </li>
                    
                    <li class="nav-item"> 
                        <a class="nav-link" href="{{route('report_list')}}" title="Reports">
                            <img src="{!! asset('images/icons/Reports_Icon@2x.png') !!}" alt="Reports">
                        </a>
                    </li>
            ...
            @elseif($loginUser->user_type == 1 || $loginUser->user_type == 3 || $loginUser->user_type == 5 || $loginUser->user_type == 6 || $loginUser->user_type == 7 || $loginUser->user_type == 8 || $loginUser->user_type == 9 || $loginUser->user_type == 10 || $loginUser->user_type == 11)
            <nav class="navbar fixed-left  justify-content-center">
                <!-- .navbar-nav start -->
                <ul class="navbar-nav">
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('add_case') }}">
                            <i class="fa fa-plus fa-4x" style="color: white;font-size: 31px;"></i>
                        </a>
                    </li>
                    @endif
                    @if($loginUser->user_type == 1)
                    <li class="nav-item">
                        <a href="{{ route('iva_sourcing') }}">
                            <i class="fa fa-plus fa-4x" style="color: white;font-size: 31px;"></i>
                        </a>
                    </li>
                    @endif
                    ...
                    @if($loginUser->user_type == 3 || $loginUser->user_type == 11 || $loginUser->user_type == 9)
                    @else
                    <li class="nav-item">
                        <a class="nav-link profile" href="{{route('agent.view_calender_profile')}}" title="Profile_calender">
                            <img src="{!! asset('images/icons/calendarinfo_Icon@2x.png') !!}" alt="Workflow">
                    ...
                    <li class="nav-item">
                    <a class="nav-link" href="{{route('dmp_iva_workflow')}}" title="Workflow">
                        <img src="{!! asset('images/icons/Workflow_Icon@2x.png') !!}" alt="workflow">
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('listUser')}}" title="Workflow">
                        <img src="{!! asset('images/icons/Workflow_Icon@2x.png') !!}" alt="Profile_calender">
                        </a>
                    </li>
                    @endif
                    ...
                    @if($loginUser->user_type == 1 || $loginUser->user_type == 5 || $loginUser->user_type == 6)
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('agent.appointment_list')}}" title="Appointment List">
                            <img src="{!! asset('images/icons/Appointment_Icon@2x.png') !!}" alt="Appointment List">
                        </a>
                    ...
                    @endif
                    @if($loginUser->user_type == 1 || $loginUser->user_type == 7)
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('listUser')}}" title="Dashboard">
                            <img src="{!! asset('images/icons/Dashboard_Icon@2x.png') !!}" alt="Dashboard" width="40" style="position:relative;right:5px;width:40px;">
                        </a>
...
<nav class="navbar fixed-left  justify-content-center">
    <ul class="navbar-nav">
        ...
        @endif
        @if($loginUser->user_type == 1 || $loginUser->user_type == 10 || $loginUser->user_type == 9 || $loginUser->user_type == 8)
        <li class="nav-item">
            <a class="nav-link"  href="{{ route('agent.callback_list') }}" title="Reports">
                <img src="{!! asset('images/icons/Reports_Icon@2x.png') !!}" alt="Reports">
            </a>
        </li>
        @endif
         @if($loginUser->user_type != 12)
            <li class="nav-item">
                <a class="nav-link" href="{{route('agent.appointment_list')}}" title="Search">
...
<ul class="clearfix list-unstyled expend-sidebar-link">
         <li class="nav-item">
            <a href="javascript:void(0)" title="Log Out" data-toggle="modal" data-backdrop="static" data-keyboard="false" data-keyboard="false" data-target="#logoff_modal" class="nav-link pl-0" style="color:#fff">
    ...
    <ul class="navbar-nav">
        @if($loginUser->user_type != 12)
            <li class="{{ (Route::currentRouteName() == 'home') ? 'active' : '' }} nav-item">
                <a class="nav-link" href="{{ route('home') }}" title="Profile">Profile</a>
            </li>
        @endif
        @if($loginUser->user_type == 3 || $loginUser->user_type == 11 || $loginUser->user_type == 9 || $loginUser->user_type == 10)
        @else
        @if($loginUser->user_type != 12)
            <li class="{{ (Route::currentRouteName() == 'agent.view_calender_profile') ? 'active' : '' }} nav-item">
                <a class="nav-link profile" href="{{route('agent.view_calender_profile')}}" title="calendar">Calendar</a>
            </li>
        @endif
        @endif
        ...
        @if($loginUser->user_type == 7 || $loginUser->user_type == 8)
        <!--<li class="{{ (Route::currentRouteName() == 'agent.appointment_list') ? 'active' : '' }} nav-item">-->
        <!--    <a class="nav-link" href="{{ route('agent.appointment_list') }}" title="Appointment List">Reminder List</a>-->
        <!--</li>-->
        @endif
        @if($loginUser->user_type != 12)
            <li class="{{ (Route::currentRouteName() == 'agent.appointment_list') ? 'active' : '' }} nav-item">
        ...
        @endif
        @if($loginUser->user_type == 1 || $loginUser->user_type == 7 || $loginUser->user_type == 8)
        <li class="nav-item">
            <a class="nav-link" href="{{route('listUser')}}" title="Dashboard">
                Dashboard
            </a>
        ...
        @if($loginUser->user_type == 1 || $loginUser->user_type == 9 || $loginUser->user_type == 10)
        <li class="{{ (Route::currentRouteName() == 'agent.appointment_list') ? 'active' : '' }} nav-item">
            <a class="nav-link" href="{{ route('agent.appointment_list') }}" title="Appointment List">Appointment List</a>
        </li>
        <li class="{{ (Route::currentRouteName() == 'completed_list') ? 'active' : '' }} nav-item">
